			...
			<table class="list">
				<tbody>
					<tr>
						...
						<td width="80"><div class="STYLE1" align="center">用户图像</div></td>
                  ...
                  <s:iterator value="users" var="user">
					<tr>
                        ...
                        <td><span class="STYLE1">
                            <img alt="touxiang" style="width: 60px;height: 60px;" src="${basePath }${user.pic }"></a></span></td>
						<td><span class="STYLE1">
						...
						<td><span class="STYLE1">
						   <s:if test="#user.type == 0">管理员</s:if>
						   <s:else>普通用户</s:else>
						</span></td>
